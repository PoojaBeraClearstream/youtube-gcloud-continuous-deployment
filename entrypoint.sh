...
ACTIONS_RUNNER_INPUT_TOKEN="$(curl -sS --request POST --url "https://api.github.com/repos/PoojaBeraClearstream/youtube-gcloud-continuous-deployment/actions/runners/registration-token" --header "authorization: Bearer AVCJM2GVQL2T6VYFAXEQ64DBS62VW"  --header 'content-type: application/json' | jq -r .token)"
# configure runner
